...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\linewidth]{figures/genre_distribution_stacked.png}
...
\begin{figure}[h]
    ...
    \begin{minipage}[c]{0.46\linewidth}
        \caption{Mean harmonic BPM distance for positive pairs (real DJ transitions) and for negatives under each sampling regime. Random negatives sit at 11.45 BPM, well above the 4.90 BPM mean of positives, so harmonic BPM is a strong discriminator. Hard negatives, constrained within $\pm 5$ BPM of a positive anchor, drop to 1.85 BPM, tighter in tempo than the positives themselves. The cue therefore disappears under hard sampling, forcing the model to rely on non-tempo features.}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/feature_importance_gbm.png}
